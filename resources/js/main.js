...
document.getElementById('add').addEventListener('mouseover', function (){
  document.getElementById('plus-sign').classList.add('fill-black');
  document.getElementById('plus-sign').classList.remove('fill');
});

document.getElementById('add').addEventListener('mouseout', function (){
  document.getElementById('plus-sign').classList.add('fill');
  document.getElementById('plus-sign').classList.remove('fill-black');
});
...
function removeItem() {
  ...
  removedList.appendChild(thisItem);
}
...
function completeItem() {
  ...
  var parentID = thisItem.parentNode.getAttribute('id');



  if (parentID === 'todo') {
    console.log(parentID);
      doneList.appendChild(thisItem);

  } else {
    console.log("it's already done");
    todoList.appendChild(thisItem);
  }
